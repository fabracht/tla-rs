---- MODULE MQDBConsumerGroup_BugNoRebalanceOnTimeout ----
...
BuggyRemoveStaleConsumer(group, consumer) ==
    /\ consumer \in members[group]
    /\ time - heartbeat[consumer] > HeartbeatTimeout
    /\ members' = [members EXCEPT ![group] = @ \ {consumer}]
    /\ UNCHANGED <<assignments, heartbeat, time>>
...
Next ==
    ...
    \/ Tick
    \/ \E g \in Groups, c \in Consumers : BuggyRemoveStaleConsumer(g, c)
