...
OutboxEntry == [
    ...
    dispatched_count: 0..EventsPerOp
]
...
Init ==
    /\ outbox = {[op_id |-> op, num_events |-> EventsPerOp, retries |-> 0, dispatched_count |-> 0] : op \in OperationIds}
    /\ dead_letter = {}
...
StartDispatch(entry) ==
    ...
    /\ dispatch_idx' = entry.dispatched_count + 1
