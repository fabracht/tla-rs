...
\* WITH fairness: if Deliver is enabled, it eventually happens
\* This should PASS - delivery cannot be starved
Spec == Init /\ [][Next]_vars /\ WF_vars(DeliverAction) /\ (SomethingPending ~> SomethingDelivered)
